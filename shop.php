...
-->
														...
														<div class="col-md-12">
															<div class="form-group">
																<iframe id="locmap" class="w-100" src="https://maps.google.com/maps?q=university%20of%20san%20francisco&amp;t=&amp;z=13&amp;ie=UTF8&amp;iwloc=&amp;output=embed" height="300"></iframe>
															</div>
														</div>
													</div>
													<div class="row">
													...
													<div class="col-lg-6">
														<div class="package-box main-box">
															<div class="package-img">
																<a href="#">
																	<img src="Add%20Recyclecenter_files/package-1.png" class="img-fluid full-width" alt="package image">
																</a>
															</div>
															<div class="package-caption padding-20 bg-black">
																<div class="package-item-first">
																	...
																	<div class="pack-type fs-18 text-light-green">INR XXXX</div>
																</div>
																<ul>
																	<li class="text-custom-white"><span>1 month subscription</span>
																	</li>
																	<li class="text-custom-white"><span>Unlimited Products</span>
																	</li>
																	<li class="text-custom-white"><span>1 Featured Product</span>
																	</li>
<!--
...
-->
													...
													<div class="col-lg-6">
														<div class="package-box main-box">
															<div class="package-img">
																<a href="#">
																	<img src="Add%20Recyclecenter_files/package-2.png" class="img-fluid full-width" alt="package image">
																</a>
															</div>
															<div class="package-caption padding-20 bg-black">
																<div class="package-item-first">
																...
																<ul>
																	<li class="text-custom-white"><span>6 months</span>
																	</li>
																	<li class="text-custom-white"><span>Unlimited Products</span>
																	</li>
																	<li class="text-custom-white"><span>1 Featured Product</span>
